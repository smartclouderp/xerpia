...
class GetAccountsReceivableReportController
{
    ...
    /**
     * Obtiene el informe de cuentas por cobrar
     * @param string|null $date_to
     * @return array
     */
    public function get($date_to = null)
    {
        // Supongamos que las transacciones positivas son por cobrar y tienen un third_party_id (cliente)
